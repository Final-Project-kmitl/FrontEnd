...
import 'package:frontend/sections/category_section.dart';
import 'package:frontend/sections/suggestion_section.dart';
...
class HomePage extends StatefulWidget {
  ...
  final Function normalScroll;
  const HomePage(
      {Key? key, required this.onScrollEnd, required this.normalScroll})
      : super(key: key);
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    _checkScrollController.addListener(() {
      if (_checkScrollController.position.atEdge &&
          _checkScrollController.position.pixels != 0) {
        widget.onScrollEnd();
      } else {
        widget.normalScroll();
      }
      // ... other scroll handling ...
    });
  }
